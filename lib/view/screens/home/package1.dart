...
class Package1Widget extends StatelessWidget {
  Package1Widget({super.key});
  ...
  final List<CardModel> cards = [
    ...
    CardModel(
        ...
        subtitle: LocaleKeys.pcsPrice.tr(),
        name: LocaleKeys.organicBanana.tr(),
        price: 4.99),
    CardModel(
